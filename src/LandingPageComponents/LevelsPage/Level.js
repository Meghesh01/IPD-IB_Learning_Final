...
export default function Level(props) {
  ...
  const navigate = useNavigate()
    ...
    const navigateLevel3 = () => {
         navigate('/Levelmainpage3',{state: {phone:props.phone}});
    }
    const navigateLevel4 = () => {
         navigate('/Levelmainpage4',{state: {phone:props.phone,beneficiaryaccountnumber:props.beneficiaryaccountnumber,branch:props.branch}});
    }
    ...
    const navigateLevel8 = () => {
         navigate('/Levelmainpage8',{state: {phone:props.phone}});
    }
    const navigateLevel9 = () => {
         navigate('/Level9',{state: {phone:props.phone}});
    }
  return (
    <>
      <div id="levelspagenew">
        ...
        <div className="container">
          ...
          {/* <button onClick={navigateLevel1} class="button-29" role="button">1</button> */}
            ...
            <button onClick={navigateLevel3} className="level">
              <div className="part">
                <div className='parthead'><u>Level</u></div>
            ...
            <button onClick={navigateLevel4} className="level">
              <div className="part">
                <div className='parthead'><u>Level</u></div>
            ...
            <button onClick={navigateLevel5} className="level">
              <div className="part">
                <div className='parthead'><u>Level</u></div>
            ...
            <button onClick={navigateLevel9} className="level">
              <div className="part">
                <div className='parthead'><u>Level</u></div>
